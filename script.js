...
let gapHeight = backgroundGap.outerHeight(true);
...
$(window)
    ...
    .resize(() => { setTimeout(grabNewHeights, 100) });
...
function grabNewHeights() {
    gapHeight = backgroundGap.outerHeight(true);
...
function scrollHandler() {
    ...
    for (let i = 0; i < sections.length; i++) {
        if (leftSection !== i && scrollTop > sections[i][0] && scrollTop < sections[i][1]) {
